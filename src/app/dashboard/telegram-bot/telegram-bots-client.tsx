...
import { Plus, Loader2, AlertCircle, LogOut } from 'lucide-react';
...
interface TelegramBotsClientProps {
  isConnected: boolean;
}

export function TelegramBotsClient({ isConnected }: TelegramBotsClientProps) {
      ...
      <div className='flex h-full flex-col space-y-4 w-full'>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {isConnected ? (
              <form onSubmit={(e) => { e.preventDefault(); handleDisconnect(); }}>
              ...
              <Link href="/dashboard/telegram-connect">
                <Button>
                  Connect Telegram
                </Button>
              </Link>
